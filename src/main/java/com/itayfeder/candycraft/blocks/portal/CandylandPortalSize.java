...
public class CandylandPortalSize {
    private static final AbstractBlock.IPositionPredicate field_242962_a = (p_242966_0_, p_242966_1_, p_242966_2_) -> {
        return p_242966_1_.getBlockState(p_242966_2_).getBlock() == ModBlocks.SUGAR_BLOCK.get();
    };
    ...
    public static Optional<CandylandPortalSize> createOptional(IWorld p_242964_0_, BlockPos p_242964_1_, Direction.Axis p_242964_2_) {
        return func_242965_a(p_242964_0_, p_242964_1_, (p_242968_0_) -> {
            return p_242968_0_.isValid() && p_242968_0_.portalBlockCount == 0;
        }, p_242964_2_);
    }

    public static Optional<CandylandPortalSize> func_242965_a(IWorld p_242965_0_, BlockPos p_242965_1_, Predicate<CandylandPortalSize> p_242965_2_, Direction.Axis p_242965_3_) {
        Optional<CandylandPortalSize> optional = Optional.of(new CandylandPortalSize(p_242965_0_, p_242965_1_, p_242965_3_)).filter(p_242965_2_);
        if (optional.isPresent()) {
            return optional;
        } else {
            Direction.Axis direction$axis = p_242965_3_ == Direction.Axis.X ? Direction.Axis.Z : Direction.Axis.X;
            return Optional.of(new CandylandPortalSize(p_242965_0_, p_242965_1_, direction$axis)).filter(p_242965_2_);
        }
    }

    public CandylandPortalSize(IWorld worldIn, BlockPos pos, Direction.Axis axisIn) {
        this.world = worldIn;
        this.axis = axisIn;
    ...
    private int func_242969_a(BlockPos.Mutable p_242969_1_) {
        for(int i = 0; i < 21; ++i) {
            ...
            for(int j = 0; j < this.width; ++j) {
                ...
                if (blockstate.isIn(ModBlocks.CANDYLAND_PORTAL.get())) {
    ...
    private static boolean func_196900_a(BlockState p_196900_0_) {
        return p_196900_0_.isAir() || p_196900_0_.func_235714_a_(BlockTags.field_232872_am_) || p_196900_0_.isIn(ModBlocks.CANDYLAND_PORTAL.get());
    }
    ...
    public void placePortalBlocks() {
        BlockState blockstate = ModBlocks.CANDYLAND_PORTAL.get().getDefaultState().with(CandylandPortalBlock.AXIS, this.axis);
