...
public class CandylandPortalTeleporter implements net.minecraftforge.common.util.ITeleporter {
    protected final ServerWorld world;

    public CandylandPortalTeleporter(ServerWorld worldIn) {
        this.world = worldIn;
    }
    ...
    public Optional<TeleportationRepositioner.Result> func_242957_a(BlockPos p_242957_1_, boolean p_242957_2_) {
        ...
        Optional<PointOfInterest> optional = pointofinterestmanager.getInSquare((p_242952_0_) -> {
            return p_242952_0_ == CandylandPortalPoi.poi;
    ...
    public Optional<TeleportationRepositioner.Result> buildPortal(BlockPos p_242956_1_, Direction.Axis p_242956_2_, World newWorld) {
        ...
        BlockState blockstate = ModBlocks.CANDYLAND_PORTAL.get().getDefaultState().with(CandylandPortalBlock.AXIS, p_242956_2_);
