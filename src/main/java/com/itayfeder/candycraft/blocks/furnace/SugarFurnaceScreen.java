...
public class SugarFurnaceScreen extends ContainerScreen<SugarFurnaceContainer> implements IRecipeShownListener {
    ...
    public SugarFurnaceScreen(SugarFurnaceContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
        this(screenContainer, new SugarFurnaceRecipeGui(), inv, titleIn, new ResourceLocation(CandyCraft.MOD_ID, "textures/gui/container/sugar_furnace.png"));
    }

    protected SugarFurnaceScreen(SugarFurnaceContainer screenContainer, AbstractRecipeBookGui recipeGuiIn, PlayerInventory inv, ITextComponent titleIn, ResourceLocation guiTextureIn) {
