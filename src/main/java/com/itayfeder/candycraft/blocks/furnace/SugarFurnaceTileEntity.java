...
public class SugarFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return SugarFurnaceTileEntity.this.burnTime;
                case 1:
                    return SugarFurnaceTileEntity.this.recipesUsed;
                case 2:
                    return SugarFurnaceTileEntity.this.cookTime;
                case 3:
                    return SugarFurnaceTileEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    SugarFurnaceTileEntity.this.burnTime = value;
                    break;
                case 1:
                    SugarFurnaceTileEntity.this.recipesUsed = value;
                    break;
                case 2:
                    SugarFurnaceTileEntity.this.cookTime = value;
                    break;
                case 3:
                    SugarFurnaceTileEntity.this.cookTimeTotal = value;
            }
    ...
    public SugarFurnaceTileEntity() {
        super(ModTileEntities.SUGAR_FURNACE.get());
    ...
    protected Container createMenu(int id, PlayerInventory player) {
        return new SugarFurnaceContainer(id, player, this);
    }
    ...
    public CompoundNBT write(CompoundNBT compound) {
        ...
        System.out.println("Testo presto");
